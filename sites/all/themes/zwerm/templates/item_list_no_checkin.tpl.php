 ...
 */
    ...
    print ('In dit scherm vind je de spelers uit je team waar je nog nooit mee hebt ingechecked en dus punten kunt verdienen door samen in te checken aan de Holle boom.');
    print('</div>');
